...
def category(x):
    if x in [
        "Biscoff Mochi Cookie",
        "Cup C",
        "Hella Nutella",
        "Small Box of 5",
        "Salty Oreo Cream Cheese",
        "Pbj",
        "Red Velvet Cream Cheese",
        "Death By Chocolate",
        "Large Box of 12",
        "Vegan Dark Chocolate Valrhona",
        "Cookie Gift Box",
    ...
    if x in [
        ...
        "Love Is Love Bundle Set",
        "Sweetheart",
        "Ferrero Chocolate Tart",
        "Young Coconut Cake",
        "Very Berry Basque Cheesecake",
        "Cup C Cookie Cake",
        "Lady In Pink",
        "Carrot Cream Cheese",
        "Chocolate Pudding",
        ...
        "Strawberry Kiss",
        "Mixed Berry Cheesepie",
        "Mayongchid Cheesepie (1lb)",
    ]:
        return "CAKES"
    if x in [
        "Nutty Lady",
...
basketpp = (
    data.groupby(["Order ID", "Cart"])["Quantity"]
    .sum()
    .unstack()
    .reset_index()
    .fillna(0)
...
basketcc = (
    data.groupby(["Order ID", "Category"])["Quantity"]
    .sum()
    .unstack()
    .reset_index()
    .fillna(0)
